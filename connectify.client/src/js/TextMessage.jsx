...
const TextMessage = ({ message, onReply, onDelete }) => {
    ...
    const renderMessageContent = () => {
        ...
        if (message.deleted) {
            return (
                <div className="inline-block px-4 py-2 rounded-[20px] bg-gradient-to-tr from-sky-500 to-blue-500 text-white shadow max-w-full overflow-hidden">
        ...
        if (message.type === 1) {
            ...
            return (
                <div className="px-4 py-2 rounded-lg bg-gray-200 shadow">
        ...
        <>
            <div className={`flex gap-2 items-center ${message.isSent ? 'flex-row-reverse items-end' : 'items-start'}`}>
                ...
                <div className="relative" ref={optionsRef}>
                    ...
                    />}
                    {showOptions && (
                        <div className={`absolute ${message.isSent ? 'right' : 'left'}-0 mt-2 w-32 bg-white shadow-lg rounded`}>
